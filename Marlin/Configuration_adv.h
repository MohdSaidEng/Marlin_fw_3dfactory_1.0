...
//#define LCD_BACKLIGHT_TIMEOUT 30 // (s) Timeout before turning off the backlight
  ...
  #define PROBE_OFFSET_WIZARD       // Add a Probe Z Offset calibration option to the LCD menu
    ...
    #define X_AXIS_TWIST_COMPENSATION //@MohdSaidEng
...
// LCD Print Progress options
  ...
  #define POWER_LOSS_RECOVERY
    ...
    #define POWER_LOSS_ZRAISE       15 // (mm) Z axis raise on resume (on power loss with UPS)
    ...
    #define POWER_LOSS_PURGE_LEN   30 // (mm) Length of filament to purge on resume
    #define POWER_LOSS_RETRACT_LEN 15 // (mm) Length of filament to retract on fail. Requires backup power.
 ...
 */
#define STARTUP_COMMANDS "M117 Hi Genius\n" //MohdSaidEng
...
#define CUSTOM_MENU_MAIN
  ...
  #define MAIN_MENU_ITEM_1_GCODE "G28\nG1 X125 Y105 Z200 F2000\nM104 S260\nM117 Setting Nozzle to 260C\nG4 s10\nM0 Click when Finished\nM104 S0"
  ...
  #define MAIN_MENU_ITEM_5_DESC "Auto Set Hotend PID"
  #define MAIN_MENU_ITEM_5_GCODE "M303 C8 S210 U\nM500"
  #define MAIN_MENU_ITEM_5_CONFIRM


  #define MAIN_MENU_ITEM_6_DESC "Auto Set Bed PID"
  #define MAIN_MENU_ITEM_6_GCODE "M303 E-1 C8 S65 U\nM500"
...
/**
 * User-defined buttons to run custom G-code. //@MohdSaidEng
